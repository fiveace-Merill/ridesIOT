...
function Services() {
    return (
        <div>
            <div className="flex flex-col md:invisible">
                <h3 className='self-center text-forest_green-400 text-xl'>Products</h3>
            ...
            <div className="services md:w-3/4 md:h-52 md:flex md:items-center md:grow md:ml-auto md:mr-auto">
                <div className="md:border-2 md:border-forest_green-100 md:h-full md:flex md:flex-col md:justify-center">
                    ...
                    <p className="md:p-3 md:text-jusify">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi voluptates nostrum eveniet facere in nam modi dolor. Impedit, sunt quasi!</p>
