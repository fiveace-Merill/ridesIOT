...
function Header() {
    return (
        <div className="md:my-3 md:ml-2 md:sticky md:flex md:h-14 md:w-[99%] md:items-center md:rounded-full md:shadow-md md:shadow-yellow-100 md:bg-robin_egg_blue-400">
            <input type='text' placeholder="search" className='md:pl-0 md:rounded-full md:w-1/4 h-full md:self-center rounded-md'></input>
