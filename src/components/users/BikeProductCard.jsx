...
function BikeProductCard({ name, price, design, description }) {
    return (
        <div className='w-7/12 h-3/4 mx-1 flex flex-col justify-center shadow-lg shadow-forest_green-700 rounded-lg md:w-9/12 md:h-5/6 md:mx-auto md:mt-10'>
            ...
            <div className='w-full h-3/6 my-1 text-center'>
                ...
                <p className='text-pretty p-1 text-[9px] box-border h-2/4'>{description}</p>
