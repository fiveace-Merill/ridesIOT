...
function Login() {
    return (
        <div className='md:w-screen md:h-screen bg-white md:flex md:flex-col md:items-center md:justify-center'>
            ...
            >
                <div className='mx-5 mb-3 p-2 h-[400px] rounded-2xl bg-forest_green-200 opacity-80 flex flex-col flex-initial md:bg-white md:m-0 md:h-full md:opacity-100 md:items-center'>
                    <div className="flex flex-col mb-auto mt-5 md:w-4/6 md:grow">
                        ...
                        <p className='text-lg text-justify m-2 p-2 md:m-0 md:text-2xl md:h-full md:text-forest_green-200'>We just need to get a few details from you to get you signed in for the service.</p>
                    </div>
                    ...
                    <button className="p-3 my-3 mt-12 rounded-md bg-forest_green-400 w-32 self-center md:w-30 md:p-3 md:my-0 md:text-white md:text-sm md:rounded-2xl">SIGN UP</button>
                </div>
