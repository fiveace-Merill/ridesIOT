        ...
        <div className='md:w-screen md:h-screen bg-white md:flex md:flex-col md:items-center md:justify-center'>
            ...
            >
                <div className='mx-5 mb-3 p-2 h-4/6 rounded-2xl bg-forest_green-200 opacity-80 flex flex-col flex-initial md:bg-white md:m-0 md:h-full md:w-7/12 md:opacity-100 md:items-center'>
                    ...
                    <form className="flex flex-col grow justify-start h-auto self-center md:justify-center md:w-4/6 md:h-2/6 md:self-center py-2">
                        <input type='text' placeholder="First Name" className="my-2 h-6 w-full rounded-lg pl-2 md:my-3 md:h-8 md:border-2 md:border-forest_green-400" id='first'></input>
                        <input type='text' placeholder="Last Name" className="my-2 h-6 w-full rounded-lg pl-2 md:my-3 md:h-8  md:border-2 md:border-forest_green-400" id='last'></input>
                        <input type='email' placeholder="email" className="my-2 h-6 w-full rounded-lg pl-2 md:my-3 md:h-8 md:border-2 md:border-forest_green-400"></input>
                        <input type='password' placeholder="password" className="my-2 h-6 w-full rounded-lg pl-2 md:my-3 md:h-8 md:border-2 md:border-forest_green-400"></input>
                    </form>
                    <div className='h-8 flex flex-row justify-center items-center md:w-full md:items-center' >
                        <button className="p-2 rounded-md bg-forest_green-400 w-32 self-center md:w-30 md:p-3 md:mb-2 text-white text-sm md:rounded-2xl md:self-center md:ml-[20%]">Sign Up</button>
