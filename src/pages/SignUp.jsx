            ...
            >
                <div className='mx-5 mb-3 p-2 h-4/6 rounded-2xl bg-forest_green-200 opacity-80 flex flex-col flex-initial md:bg-white md:m-0 md:h-full md:w-7/12 md:opacity-100 md:items-center'>
                    ...
                    <form onSubmit={(event) => handleSubmit(event)} className="flex flex-col grow justify-start h-auto self-center md:justify-center md:w-4/6 md:h-2/6 md:self-center py-2" htmlFor='submit'>
                        <input type='email' placeholder="email" value={userEmail} className="my-2 h-6 w-full rounded-lg pl-2 md:my-3 md:h-8 md:border-2 md:border-forest_green-400" onChange={(event) => handleEmailChange(event)}></input>
                        <input type='password' placeholder="password" value={userPassword} className="my-2 h-6 w-full rounded-lg pl-2 md:my-3 md:h-8 md:border-2 md:border-forest_green-400" onChange={(event) => handlePasswordChange(event)}></input>
